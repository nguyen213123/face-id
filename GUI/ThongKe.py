...
from BUS.ThongKeBUS import ThongKeBUS
import time
...
class UI_ThongKe(object):
        ...
        "")
                ...
                self.cmbOptionFindDiMuon.addItem("Mã SV", "masinhvien")
                self.cmbOptionFindDiMuon.addItem("Họ tên", "hoten")
                self.cmbOptionFindDiMuon.addItem("Lớp", "malop")
                self.cmbOptionFindDiMuon.addItem("Ngày", "ngay")
                self.cmbOptionFindDiMuon.addItem("ID buổi học", "mabuoihoc")
                self.cmbOptionFindDiMuon.currentIndexChanged.connect(self.findDiMuon)
                ...
                self.txtFindDiMuon.textChanged.connect(self.findDiMuon)
        ...
        "}")
                ...
                self.btnExportDiMuon.clicked.connect(self.filedimuon)
                ...
                self.tbwDiMuon.setColumnCount(5)
                self.tbwDiMuon.setRowCount(self.ddCount)
        ...
        "")
                ...
                self.txtFindVang.textChanged.connect(self.findVang)
                ...
                self.cmbOptionFindVang.addItem("Mã SV", "masinhvien")
                self.cmbOptionFindVang.addItem("Họ tên", "hoten")
                self.cmbOptionFindVang.addItem("Lớp", "malop")
                self.cmbOptionFindVang.addItem("Ngày", "ngay")
                self.cmbOptionFindVang.addItem("ID buổi học", "mabuoihoc")
                self.cmbOptionFindVang.currentIndexChanged.connect(self.findDiMuon)
        ...
        "}")
                ...
                self.btnExportVang.clicked.connect(self.filevang)
                ...
                self.tbwVang.setColumnCount(5)
                self.tbwVang.setRowCount(self.ddCount)
                item = QtWidgets.QTableWidgetItem()
        ...
        "")
                ...
                self.txtFindKhongDD.textChanged.connect(self.findKDD)
                ...
                self.cmbOptionFindKhongDD.addItem("Mã SV", "masinhvien")
                self.cmbOptionFindKhongDD.addItem("Họ tên", "hoten")
                self.cmbOptionFindKhongDD.addItem("Lớp", "malop")
                self.cmbOptionFindKhongDD.addItem("Ngày", "ngay")
                self.cmbOptionFindKhongDD.addItem("ID buổi học", "mabuoihoc")
                self.cmbOptionFindKhongDD.currentIndexChanged.connect(self.findDiMuon)
        ...
        "}")
                ...
                self.btnExportKhongDD.clicked.connect(self.fileKDD)
                ...
                self.tbwKhongDD.setColumnCount(5)
                self.tbwKhongDD.setRowCount(self.ddCount)
                item = QtWidgets.QTableWidgetItem()
        ...
        def __init__(self):
                tkBUS = ThongKeBUS()
                self.svCount = tkBUS.svcount()
                self.ddCount = tkBUS.ddcount()
                self.lateCount = tkBUS.latecount()
                self.absentCount = tkBUS.absentcount()
                self.KDDCount = tkBUS.KDDcount()
                self.listDiMuon = tkBUS.list_DiMuon()
                self.listVang = tkBUS.list_Vang()
                self.listKDD = tkBUS.list_KDD()

        def retranslateUi(self, MainWindow):
                _translate = QtCore.QCoreApplication.translate
                MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
                self.label_3.setText(_translate("MainWindow", "Thống kê hệ thống"))
                self.btnBack.setText(_translate("MainWindow", "Trở về"))
                self.lbSoSV.setText(_translate("MainWindow", "Số sinh viên"))
                self.lblResultSV.setText(_translate("MainWindow", str(self.svCount)))
                self.lblResultDiemDanh.setText(_translate("MainWindow", str(self.ddCount)))
                ...
                self.lblResultDiMuon.setText(_translate("MainWindow", str(self.lateCount)))
                self.lblResultVang.setText(_translate("MainWindow", str(self.absentCount)))
        ...
        def showDiMuon(self):
                tablerow=0
                if self.listDiMuon is not None:
                        for row in self.listDiMuon:
                                self.tbwDiMuon.setItem(tablerow, 0, QtWidgets.QTableWidgetItem(row[0]))
                                self.tbwDiMuon.setItem(tablerow, 1, QtWidgets.QTableWidgetItem(row[1]))
                                self.tbwDiMuon.setItem(tablerow, 2, QtWidgets.QTableWidgetItem(row[2]))
                                self.tbwDiMuon.setItem(tablerow, 3, QtWidgets.QTableWidgetItem(row[3].strftime('%d/%m/%Y')))
                                self.tbwDiMuon.setItem(tablerow, 4, QtWidgets.QTableWidgetItem(row[4]))
                                tablerow += 1
                self.tbwDiMuon.setRowCount(tablerow)
      
        def showVang(self):
                tablerow=0
                if self.listVang is not None:
                        for row in self.listVang:
                                self.tbwVang.setItem(tablerow, 0, QtWidgets.QTableWidgetItem(row[0]))
                                self.tbwVang.setItem(tablerow, 1, QtWidgets.QTableWidgetItem(row[1]))
                                self.tbwVang.setItem(tablerow, 2, QtWidgets.QTableWidgetItem(row[2]))
                                self.tbwVang.setItem(tablerow, 3, QtWidgets.QTableWidgetItem(row[3].strftime('%d/%m/%Y')))
                                self.tbwVang.setItem(tablerow, 4, QtWidgets.QTableWidgetItem(row[4]))
                                tablerow += 1
                self.tbwVang.setRowCount(tablerow)


        def showKDD(self):
                tablerow=0
                if self.listKDD is not None:
                        for row in self.listKDD:
                                self.tbwKhongDD.setItem(tablerow, 0, QtWidgets.QTableWidgetItem(row[0]))
                                self.tbwKhongDD.setItem(tablerow, 1, QtWidgets.QTableWidgetItem(row[1]))
                                self.tbwKhongDD.setItem(tablerow, 2, QtWidgets.QTableWidgetItem(row[2]))
                                self.tbwKhongDD.setItem(tablerow, 3, QtWidgets.QTableWidgetItem(row[3].strftime('%d/%m/%Y')))
                                self.tbwKhongDD.setItem(tablerow, 4, QtWidgets.QTableWidgetItem(row[4]))
                                tablerow += 1
                self.tbwKhongDD.setRowCount(tablerow)


        def filedimuon(self):
                x = {'Mã SV':[], 'Họ Tên': [], 'Lớp': [], 'Ngày': [], 'ID buổi học': []}
                for index, sv in enumerate(self.listDiMuon):
                        x.get('Mã SV').append(sv[0])
                        x.get('Họ Tên').append(sv[1])
                        x.get('Lớp').append(sv[2])
        ...
        def filevang(self):
                x = {'Mã SV': [], 'Họ Tên': [], 'Lớp': [], 'Ngày': [], 'ID buổi học': []}
                for index, sv in enumerate(self.listVang):
                        x.get('Mã SV').append(sv[0])
                        x.get('Họ Tên').append(sv[1])
                        x.get('Lớp').append(sv[2])
                        x.get('Ngày').append(sv[3])
        ...
        def fileKDD(self):
                x = {'Mã SV': [], 'Họ Tên': [], 'Lớp': [], 'Ngày': [], 'ID buổi học': []}
                for index, sv in enumerate(self.listKDD):
                        x.get('Mã SV').append(sv[0])
                        x.get('Họ Tên').append(sv[1])
                        x.get('Lớp').append(sv[2])
                        x.get('Ngày').append(sv[3])
        ...
        def findDiMuon(self):
                tk = ThongKeBUS()
                key =  self.cmbOptionFindDiMuon.currentData() 
                value = self.txtFindDiMuon.text()
                #print(key)
                list = tk.find_DiMuon(key, value)
                tablerow=0
                self.tbwDiMuon.setRowCount(list.__len__())
                #print(list)
                if list is not None:
                        for row in list:
                                self.tbwDiMuon.setItem(
                                ...
                                self.tbwDiMuon.setItem(
                                tablerow, 3, QtWidgets.QTableWidgetItem(row[3].strftime('%d/%m/%Y')))
                                self.tbwDiMuon.setItem(
        ...
        def findVang(self):
                tk = ThongKeBUS()
                key =  self.cmbOptionFindVang.currentData() 
                value = self.txtFindVang.text()
                #print(key)
                list = tk.find_Vang(key, value)
                tablerow=0
                self.tbwVang.setRowCount(list.__len__())
                #print(list)
                if list is not None:
                        for row in list:
                                self.tbwVang.setItem(
                                tablerow, 0, QtWidgets.QTableWidgetItem(row[0]))
                                self.tbwVang.setItem(
                                tablerow, 1, QtWidgets.QTableWidgetItem(row[1]))
                                self.tbwVang.setItem(
        ...
        def findKDD(self):
                tk = ThongKeBUS()
                key =  self.cmbOptionFindKhongDD.currentData() 
                value = self.txtFindKhongDD.text()
                #print(key)
                list = tk.find_KhongDD(key, value)
                tablerow=0
                self.tbwKhongDD.setRowCount(list.__len__())
                #print(list)
                if list is not None:
                        for row in list:
                                self.tbwKhongDD.setItem(
                                tablerow, 0, QtWidgets.QTableWidgetItem(row[0]))
                                self.tbwKhongDD.setItem(
                                tablerow, 1, QtWidgets.QTableWidgetItem(row[1]))
                                self.tbwKhongDD.setItem(
